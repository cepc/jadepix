...
def main(a1_source_fname,\
    ...
    a1_cluster_hist = ROOT.TH1F('a1 seed signal','{}^{55}Fe  Seed Signal',bin_number,0,6000)
    ...
    a2_cluster_hist = ROOT.TH1F('a2 seed signal','{}^{55}Fe  Seed Signal',bin_number,0,6000)
    ...
    a3_cluster_hist = ROOT.TH1F('a3 seed signal','{}^{55}Fe  Seed Signal',bin_number,0,6000)
    ...
    for a1_cluster_entry in xrange(a1_cluster_entries):
        ...
        a1_cluster_hist.Fill(a1_cluster_tree.SeedSignal)
    ...
    for a2_cluster_entry in xrange(a2_cluster_entries):
        ...
        a2_cluster_hist.Fill(a2_cluster_tree.SeedSignal)
    ...
    for a3_cluster_entry in xrange(a3_cluster_entries):
        ...
        a3_cluster_hist.Fill(a3_cluster_tree.SeedSignal)
    a3_peak_adc = a3_cluster_hist.GetMaximumBin() 
    a3_cluster_hist.Scale(1/a3_cluster_hist.Integral())


    legend.AddEntry(a1_cluster_hist,'A1 : seed signal ')
    legend.AddEntry(a2_cluster_hist,'A2 : seed signal ')
    legend.AddEntry(a3_cluster_hist,'A3 : seed signal ')
    ...
    legend.Draw()
    canvas.Update()
    canvas.SaveAs('../fig/Iron55_Seed_123.gif')
