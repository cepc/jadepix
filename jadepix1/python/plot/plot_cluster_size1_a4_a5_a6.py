...
def main(a4_source_fname,\
    ...
    a4_cluster_hist = ROOT.TH1F('a4 cluster signal','{}^{55}Fe  Cluster Size = 1',bin_number,0,6000)
    ...
    a5_cluster_hist = ROOT.TH1F('a5 cluster signal','{}^{55}Fe  Cluster Size = 1',bin_number,0,6000)
    ...
    a6_cluster_hist = ROOT.TH1F('a6 cluster signal','{}^{55}Fe  Cluster Size = 1',bin_number,0,6000)
    ...
    legend.AddEntry(a4_cluster_hist,'A4 : cluster size = 1 ')
    legend.AddEntry(a5_cluster_hist,'A5 : cluster size = 1 ')
    legend.AddEntry(a6_cluster_hist,'A6 : cluster size = 1 ')
    ...
    legend.Draw()
    canvas.Update()
    canvas.SaveAs('../fig/Iron55_Cluster_Size1_456.gif')
