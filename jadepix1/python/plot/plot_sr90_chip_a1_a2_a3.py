...
def main(a1_source_fname,\
    ...
    a1_cluster_hist = ROOT.TH1F('a1 cluster signal','',cluster_bin_number,0,30000)
    ...
    a2_cluster_hist = ROOT.TH1F('a2 cluster signal','',cluster_bin_number,0,30000)
    ...
    a3_cluster_hist = ROOT.TH1F('a3 cluster signal','',cluster_bin_number,0,30000)
    ...
    a1_seed_hist = ROOT.TH1F('a1 seed signal','',seed_bin_number,0,30000)
    ...
    a2_seed_hist = ROOT.TH1F('a2 seed signal','',seed_bin_number,0,30000)
    ...
    a3_seed_hist = ROOT.TH1F('a3 seed signal','',seed_bin_number,0,30000)
    ...
    cluster_canvas.SaveAs('./python/fig/Sr90_Cluster55_123.pdf')
    ...
    seed_legend.Draw()
    seed_canvas.Update()
    seed_canvas.SaveAs('./python/fig/Sr90_Seed_123.pdf')
    ...
    size_legend.Draw()
    size_canvas.Update()
    size_canvas.SaveAs('./python/fig/Sr90_Size_123.pdf')



if __name__ == '__main__':
    
    main('./python/output/CHIPA1_Cluster55_Sr90_thr500.root',\
         './python/output/CHIPA2_Cluster55_Sr90_thr500.root',\
         './python/output/CHIPA3_Cluster55_Sr90_thr500.root')
