...
def plot(a1_source_fname,a2_source_fname,a3_source_fname):
    try:
    ...
    #A1
    a1_size_hist = ROOT.TH1F('a1 size distribution','{}^{55}Fe  Size Distribution',25,0,25)
    ...
    #A2
    a2_size_hist = ROOT.TH1F('a2 size distribution','{}^{55}Fe  Size Distribution',25,0,25)
    ...
    #A3
    a3_size_hist = ROOT.TH1F('a3 size distribution','{}^{55}Fe  Size Distribution',25,0,25)
    ...
    legend.AddEntry(a1_size_hist,'   CHIP A1')
    legend.AddEntry(a2_size_hist,'   CHIP A2')
    legend.AddEntry(a3_size_hist,'   CHIP A3')
...
if __name__ == '__main__':
    plot('../output/CHIPA1_Cluster55_Iron55_thr500.root','../output/CHIPA2_Cluster55_Iron55_thr500.root','../output/CHIPA3_Cluster55_Iron55_thr500.root')
