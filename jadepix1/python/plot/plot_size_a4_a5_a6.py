...
def main(a4_source_fname,a5_source_fname,a6_source_fname):
    ...
    #A4
    a4_size_hist = ROOT.TH1F('a4 size distribution','{}^{55}Fe  Size Distribution',25,0,25)
    ...
    #A5
    a5_size_hist = ROOT.TH1F('a5 size distribution','{}^{55}Fe  Size Distribution',25,0,25)
    ...
    #A6
    a6_size_hist = ROOT.TH1F('a6 size distribution','{}^{55}Fe  Size Distribution',25,0,25)
    ...
    legend.AddEntry(a4_size_hist,'   CHIP A4')
    legend.AddEntry(a5_size_hist,'   CHIP A5')
    legend.AddEntry(a6_size_hist,'   CHIP A6')
