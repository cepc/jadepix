...
class Decode():
    ...
    def __init__(self,input,output):
        ...
        self.cluster_adc = np.zeros(1, dtype='int16')
        ...
        self.cluster_tree.Branch('ClusterSignal',self.cluster_adc,'ClusterSignal/S')
        self.cluster_tree.Branch('Size',self.size,'Size/S')

        #define thread
        self.seed_threshold = 200
        self.cluster_threshold = 200
        self.size_adc_threshold = 100  
    ...
    def fill_root(self,frame_adc):
        ...
        for row in xrange(0,48):
            for channel in xrange(0,16):
                ...
                #count size#
                if tmp_adc > self.size_adc_threshold:
                    tmp_size += 1
                #count end#
        ...
        if not overlap:
            ...
            if tmp_seed_adc > self.seed_threshold:
                ...
                if tmp_cluster_adc < 6000 :
                    ...
                    self.cluster_adc[0] = tmp_cluster_adc
