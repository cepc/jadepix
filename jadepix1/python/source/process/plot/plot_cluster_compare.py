...
def main(cluster33_source_fname,cluster33_noise_fname,cluster55_source_fname,cluster55_noise_fname,cluster77_source_fname,cluster77_noise_fname):
    ...
    cluster33_noise_hist.GetYaxis().SetTitle('Normalized Counts')
    ...
    cluster55_noise_hist.GetYaxis().SetTitle('Normalized Counts')
    ...
    cluster77_noise_hist.GetYaxis().SetTitle('Normalized Counts')
