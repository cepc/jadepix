...
def main(source_fname):
    ...
    normal_cluster_hist.GetYaxis().SetTitle('Normalized Counts')
    ...
    ex_cluster_hist.GetYaxis().SetTitle('Normalized Counts')
    ...
    edge20_cluster_hist.GetYaxis().SetTitle('Normalized Counts')
    ...
    edge15_cluster_hist.GetYaxis().SetTitle('Normalized Counts')
    ...
    edge_other_cluster_hist.GetYaxis().SetTitle('Normalized Counts')
