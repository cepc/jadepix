...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
        if sys.argv[1].startswith('-a'):
            ...
            input_dir = './python/output/output_%s_sr90'%chip_address.lower()
            output_name = './python/output/CHIP%s_Cluster55_Sr90_thr500.root'%chip_address.upper()
