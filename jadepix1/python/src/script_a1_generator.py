...
def generate(title,input,output):
    ...
    if not os.path.exists('./python/src/chip_a1/'):
        os.makedirs('./python/src/chip_a1/')

    python_file_name = './python/src/chip_a1/%s.py'%title
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./python/output/chip_a1'):
        os.makedirs('./python/output/chip_a1')

    main('/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180329/','./python/output/chip_a1/')
