...
def generate(title,input,output):
    ...
    if not os.path.exists('./python/src/src_a1_iron55/'):
        os.makedirs('./python/src/src_a1_iron55/')

    python_file_name = './python/src/src_a1_iron55/%s.py'%title
...
if __name__ == '__main__':
    ...
    if not os.path.exists('./python/output/output_a1_iron55/'):
        os.makedirs('./python/output/output_a1_iron55')

    main('/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180329/','./python/output/output_a1_iron55/')
