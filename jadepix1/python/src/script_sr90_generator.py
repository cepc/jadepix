...
def generate(chip_address,title,input,output):
    ...
    if not os.path.exists('./python/src/src_%s_sr90/'%chip_address):
        os.makedirs('./python/src/src_%s_sr90/'%chip_address)

    python_file_name = './python/src/src_%s_sr90/%s.py'%(chip_address,title)
...
if __name__ == '__main__':
    ...
    source_data_dir = {'a1':['/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180419/','/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180502/'],
                       'a2':['/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180419/','/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180502/'],
                       'a3':['/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180419/','/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180502/'],
                       'a4':['/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180419/','/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180502/'],
                       'a5':['/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180419/','/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180502/'],
                       'a6':['/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180419/','/publicfs/atlas/atlasnew/higgs/tth/hbb/raw_pixel/20180502/']}
    ...
    if len(sys.argv) == 2:
        if sys.argv[1].startswith('-a'):
            ...
            for input_dir in source_data_dir[chip_address.lower()]:
                run(chip_address,input_dir,'./python/output/output_%s_sr90/'%chip_address.lower())
    ...
    if len(sys.argv) == 3:
        if (sys.argv[1].startswith('-a') and sys.argv[2].startswith('-a')):
            ...
            for address_number in xrange(chip_address_start_number,chip_address_end_number+1):
                ...
                if not os.path.exists('./python/output/output_%s_sr90/'%chip_address.lower()):
                    os.makedirs('./python/output/output_%s_sr90/'%chip_address.lower())
